...
function Share() {
    ...
    const foodTypeOptions = ['Vegetarian', 'Non-vegetarian'];
    return (
        <div className='App' id='profileSet'>
            <div>
                ...
                <div className='para1'>
                    ...
                    <div className='p1x'>
                        This form helps you to see the details on a relevant food request. 
                    </div>
                    {/* <p className='p2x'>
            ...
            <div >
                ...
                <input style={{
                    display: 'none'
                }} className='termsCon' id='check' type="checkbox" name="remember" 
